...
export default function AboutPage() {
  ...
  const content = {
    no: {
      title: "Om Oss",
      description:
        "Lær om 4Dekk AS's 10 års erfaring, vårt team av sertifiserte teknikere, og vårt engasjement for kvalitets bilreparasjonstjenester.",
      ...
      teamTitle: "Vårt Team",
      teamDescription:
        "Møt de erfarne og sertifiserte teknikerne som holder bilen din i perfekt stand.",
      contactButton: "Kontakt Oss",
      bookButton: "Bestill Time",
      ctaTitle: "Velg oss",
      ctaDescription:
        "Bli en av våre mange fornøyde kunder som stoler på oss med sine kjøretøy. Kontakt oss, eller bestill din neste bil eller dekkservice.",
      valuesTitle: "Våre Verdier",
      honesty: "Ærlighet",
      honestyDesc:
        "Bil er dyrt, det vet vi. Derfor ønsker vi å kunne gi deg den beste opplevelsen med et transparent forhold der vi gjør vårt ytterste for å holde kostnadene dine ned og sikkerheten din oppe.",
      quality: "Kvalitetsarbeid",
      qualityDesc:
        "Våre erfarne mekanikere har årevis med erfaring på et hav av ulike produsenter, biltyper og reparasjoner. Derfor garanterer vi deg kvalitet i utføring av arbeidet uten snarveier.",
      customerFocus: "Kundefokus",
      customerFocusDesc:
        "Kunder som returnerer er livsblodet til bedriften vår, derfor ønsker vi å gjøre det ytterste for at du skulle føle at du er velkommen og ønsker å velge oss igjen neste gang.",
    },
    en: {
      title: "About Us",
      description:
        "Learn about 4Dekk AS's 10 years of experience, our team of certified technicians, and our commitment to quality car repair services.",
      ...
      aboutDescription2:
        "Today we have two bays for the workshop, one for tire service and can offer everything from EU inspection, full service, brake service, transmission service, diagnostics and much more.",
      ...
      teamTitle: "Our Team",
      teamDescription:
        "Meet the experienced and certified technicians who keep your car in perfect condition.",
      contactButton: "Contact Us",
      bookButton: "Book Appointment",
      ctaTitle: "Choose Us",
      ctaDescription:
        "Become one of our many satisfied customers who trust us with their vehicles. Contact us, or book your next car or tire service.",
      valuesTitle: "Our Values",
      honesty: "Honesty",
      honestyDesc:
        "Cars are expensive, we know that. That's why we want to give you the best experience with a transparent relationship where we do our utmost to keep your costs down and your safety up.",
      quality: "Quality Work",
      qualityDesc:
        "Our experienced mechanics have years of experience with a sea of different manufacturers, car types and repairs. That's why we guarantee you quality in the execution of the work without shortcuts.",
      customerFocus: "Customer Focus",
      customerFocusDesc:
        "Returning customers are the lifeblood of our business, that's why we want to do our utmost to make you feel welcome and want to choose us again next time.",
    },
  };
        ...
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
            <div className="p-6 text-center card-dark">
              ...
              <p className="text-text">{t.honestyDesc}</p>
            </div>
            <div className="p-6 text-center card-dark">
              <div className="mb-4 text-accent">
              ...
              <p className="text-text">{t.qualityDesc}</p>
            </div>
            <div className="p-6 text-center card-dark">
              <div className="mb-4 text-accent">
              ...
              <p className="text-text">{t.customerFocusDesc}</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
            {currentTeamMembers.map((member, index) => (
              <div key={index} className="p-6 text-center card-dark">
                ...
                <p className="font-medium text-accent">{member.position}</p>
              </div>
            ))}
          </div>
        </div>
