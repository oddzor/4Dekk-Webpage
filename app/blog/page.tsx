...
export default function BlogPage() {
  ...
  useEffect(() => {
    ...
    return () => {
      window.removeEventListener("closeBlogArticle", handleCloseBlogArticle);
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="p-8 mt-12 card-dark">
                ...
                <div className="flex flex-col justify-center gap-4 sm:flex-row">
                  <a href="/contact" className="text-center btn-secondary">
                    {language === "no" ? "Kontakt Oss" : "Contact Us"}
                  </a>
                  <a href="/booking" className="text-center btn-accent">
