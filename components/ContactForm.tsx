...
export default function ContactForm() {
  ...
  const content = {
    no: {
      ...
      sending: "Sender...",
      successMessage: "Takk for din henvendelse! Vi kommer tilbake til deg så snart som mulig.",
      errorMessage: "Noe gikk galt. Vennligst prøv igjen eller ring oss direkte.",
      ...
      privacy: "Personvern:",
      privacyText: "Ved å sende inn dette skjemaet samtykker du til å bli kontaktet angående din henvendelse."
    },
    en: {
      name: "Name",
      email: "Email",
      ...
      sending: "Sending...",
      successMessage: "Thank you for your inquiry! We'll get back to you as soon as possible.",
      ...
      privacy: "Privacy:",
      privacyText: "By submitting this form, you consent to being contacted regarding your inquiry."
    }
  }
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
      <div>
        ...
        <input
          ...
          className={`w-full px-4 py-3 bg-gray-800 border rounded-lg focus:outline-none focus:ring-2 focus:ring-accent transition-colors duration-200 text-white placeholder-gray-400 ${
            errors.regnumber ? 'border-red-500' : 'border-gray-600 hover:border-gray-500'
          }`}
          placeholder="AB12345"
        />
        {errors.regnumber && (
          <p className="mt-1 text-sm text-red-400">{errors.regnumber.message}</p>
        )}
      </div>
      ...
      <div>
        ...
        >
          <option value="" disabled hidden className="font-medium text-gray-400 bg-gray-800" style={{ 
            fontFamily: 'Roboto, sans-serif',
            fontSize: '16px',
            fontWeight: '500'
          }}>{language === 'no' ? 'Hva gjelder henvendelsen?' : 'What is your inquiry about?'}</option>
          {currentEmailSubjects.map((subject) => (
            <option key={subject.value} value={subject.value} className="font-medium text-white bg-gray-800" style={{ 
              fontFamily: 'Roboto, sans-serif',
              fontSize: '16px',
              fontWeight: '500'
            }}>
      ...
      <div>
        ...
        <textarea
          ...
          placeholder={language === 'no' ? 'Fortell så nøye som mulig hva forespørselen gjelder' : 'Please describe your inquiry in as much detail as possible'}
        />
        {errors.message && (
        ...
        <div className="space-y-3">
          ...
          <div className="flex items-start">
            ...
            <span className="text-text">
              {businessData.address.street}, {businessData.address.postalCode} {businessData.address.city}
            </span>
          </div>
        </div>
      </div>
