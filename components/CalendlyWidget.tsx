    ...
    <div className={`text-center ${className}`}>
      <div className="mb-8">
        ...
        <p className="text-text mb-6 max-w-2xl mx-auto">
          Click the button below to open our booking calendar in a new tab. 
          You'll be able to select your service type, choose a convenient time, 
          and receive confirmation via email and SMS.
        </p>
      </div>
      ...
      <div className="mt-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        <div className="card-dark p-4 text-center">
          ...
          <h4 className="font-headings font-semibold text-headings mb-1">EU Control</h4>
          <p className="text-xs text-text">60 min</p>
        </div>
        <div className="card-dark p-4 text-center">
          <div className="text-2xl mb-2">🛞</div>
          <h4 className="font-headings font-semibold text-headings mb-1">Tire Change</h4>
          <p className="text-xs text-text">15-30 min</p>
        </div>
        <div className="card-dark p-4 text-center">
          <div className="text-2xl mb-2">🛢️</div>
          <h4 className="font-headings font-semibold text-headings mb-1">Oil Change</h4>
          <p className="text-xs text-text">30 min</p>
        </div>
        <div className="card-dark p-4 text-center">
          <div className="text-2xl mb-2">🛑</div>
          <h4 className="font-headings font-semibold text-headings mb-1">Brake Service</h4>
          <p className="text-xs text-text">90 min</p>
        </div>
        <div className="card-dark p-4 text-center">
          <div className="text-2xl mb-2">🔧</div>
          <h4 className="font-headings font-semibold text-headings mb-1">Diagnostics</h4>
          <p className="text-xs text-text">45 min</p>
        </div>
        <div className="card-dark p-4 text-center">
          <div className="text-2xl mb-2">🚨</div>
          <h4 className="font-headings font-semibold text-headings mb-1">Emergency</h4>
      ...
      <div className="mt-8 p-6 card-dark">
        <h4 className="font-headings font-semibold text-headings mb-3">What to Expect</h4>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-text">
          <div className="flex items-start">
            <div className="text-accent mr-2 mt-1">✓</div>
            <span>Select your service type and duration</span>
          </div>
          <div className="flex items-start">
            <div className="text-accent mr-2 mt-1">✓</div>
          ...
          <div className="flex items-start">
            <div className="text-accent mr-2 mt-1">✓</div>
            <span>Receive confirmation via email & SMS</span>
          </div>
        </div>
      </div>
    </div>
