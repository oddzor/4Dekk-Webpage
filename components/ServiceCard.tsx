    ...
    <div className="relative w-full h-96 perspective-1000">
      ...
      >
        ...
        <div className="absolute inset-0 w-full h-full backface-hidden rotate-y-180">
          <div className="flex flex-col h-full overflow-hidden transition-all duration-500 ease-in-out card-dark border-glow-strong">
            ...
            <div className="flex-1 p-6 pt-4 space-y-4 overflow-y-auto">
              {longDescription && (
                <div className="p-4 border rounded-lg bg-gray-800/50 border-gray-700/50 backdrop-blur-sm">
                  <h4 className="mb-2 text-sm font-semibold tracking-wide uppercase text-accent">
                    {t.description}
                  </h4>
