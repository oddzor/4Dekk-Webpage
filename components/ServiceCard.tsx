  ...
  return (
    <>
      ...
      {isExpanded && showModal && (
        ...
        >
          <div
            className="relative w-full max-w-6xl max-h-[90vh] overflow-hidden card-dark border-glow-strong"
            style={{ animation: "slideUpZoom 0.5s ease-out" }}
            onClick={(e) => e.stopPropagation()}
          >
            <div className="flex flex-col h-full lg:flex-row">
              <div className="relative w-full h-48 lg:w-1/2 lg:h-auto lg:min-h-0 lg:flex-1 bg-gray-dark">
                <Image
                  src={image}
                  alt={title}
                  fill
              ...
              <div className="flex flex-col flex-1 lg:flex-[2] min-h-0 p-6 lg:p-8">
