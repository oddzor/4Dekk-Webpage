...
export function getMetadata(language: Language = 'no', path: string = '/') {
  ...
  const metadata = {
    no: {
      ...
      ogDescription: 'Profesjonell bilverksted og dekkservice i Larvik. Kvalitetsarbeid til konkurransedyktige priser.',
    ...
    en: {
      ...
      description: 'Professional car workshop and tire service in Larvik. EU inspection, repairs, tire change and more. Quality work at competitive prices.',
      keywords: 'car workshop larvik, tire service, eu inspection, tire change, car repair, 4dekk',
      ogTitle: '4Dekk Larvik - Car Workshop and Tire Service',
      ogDescription: 'Professional car workshop and tire service in Larvik. Quality work at competitive prices.',
      canonical: currentUrl,
      alternateEn: `${baseUrl}${path}?lang=en`,
      alternateNo: `${baseUrl}${path}`
    }
  ...
  const pageSpecific: Record<Language, Record<Page, { title: string; description: string }>> = {
    no: {
      ...
      about: {
        ...
        description: 'Lær mer om 4Dekk Larvik. Erfarne teknikere, moderne utstyr og utmerket kundeservice siden 2014.'
      },
      contact: {
        title: 'Kontakt Oss - 4Dekk Larvik',
        description: 'Kontakt 4Dekk Larvik for bilverksted og dekkservice. Ring 93 99 55 55 eller besøk oss på Haakon VII\'s vei 9.'
      },
      booking: {
    ...
    en: {
      ...
      about: {
        ...
        description: 'Learn more about 4Dekk Larvik. Experienced technicians, modern equipment and excellent customer service since 2014.'
      },
      contact: {
        title: 'Contact Us - 4Dekk Larvik',
        description: 'Contact 4Dekk Larvik for car workshop and tire service. Call 93 99 55 55 or visit us at Haakon VII\'s vei 9.'
      },
      booking: {
